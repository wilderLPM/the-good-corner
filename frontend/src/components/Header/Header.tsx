            ...
            < div className={styles.mainMenu}>
                <h1>
                    < Link to="/" className="button logo">
                        < span className={`${styles.mobileShortLabel} ${styles.tgc}`}>TGC</span>
                        <span className={`${styles.desktopLongLabel} ${styles.tgc}`}>THE GOOD CORNER</span>
                    </Link>
                </h1 >
                <form className={styles.form}>
                    < input className={styles.textInput} type="search" placeholder="Trouvez l'objet de vos rêves" />
                ...
                <a href="/ads/new" className="button">
